...
//
#ifndef __clfsm__arm_to_pru0_State_InitialPseudoState_h__
#define __clfsm__arm_to_pru0_State_InitialPseudoState_h__
...
#endif // defined(__gufsm__arm_to_pru0_State_InitialPseudoState__)
