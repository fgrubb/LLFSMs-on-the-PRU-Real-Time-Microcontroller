//
//Drawing_arm_receiver_and_sender_from_pru0_to_pru1_VarRefs.mm
//
//Automatically created through MiEditLLFSM -- do not change manually!
//
Drawing_arm_receiver_and_sender_from_pru0_to_pru1 *_m = static_cast<Drawing_arm_receiver_and_sender_from_pru0_to_pru1 *>(_machine);
